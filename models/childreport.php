...
class ChildReport
{
    ...
    public function createChildReport($child_name, $birthday, $guardian, $guardian_id, $Request_id, $birth_place, $area, $center, $midwife_email, $NVD, $vaccines,$Weight_details)
    {
