...
<body>
    <section class="min-vh-100 align-items-center">
        <div class="container v-100">
            <div class="row d-flex justify-content-left align-items-center h-100 my-3">
                        ...
                        <div class="card-body py-sm-5 py-md-5 px-lg-0">
                            <div class="row justify-content-center">
                                <div class="col-md-12 col-lg-9 col-xl-8 order-2 order-lg-1">
                                    ...
                                    <p class="text-center h4 fw-bold mb-4 mx-1 mx-md-4"><a href="index.php">Child Care Mangement System</a> </p>
